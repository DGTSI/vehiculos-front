...
export class OwnerInformationService {
  ...
  public loadForm(): FormGroup {
    return this.fb.group({
      ...
      ctrluinv: ['', Validators.required ],
      ctrllave: ['', Validators.required ],
      cvecalidadper: ['', Validators.required ],
      // nombre: [{ value: '', disabled: false }],
      // paterno: [{ value: '', disabled: false }],
      // materno: [{ value: '', disabled: false }],
      // curp: [{ value: '', disabled: false } ],
      // telefono: [{ value: '', disabled: false }],
      // celular: [{ value: '', disabled: false }],
      // correoe: [{ value: '', disabled: false }],
      ...
      // nointerior: [{ value: '', disabled: false }],
      // noexterior: [{ value: '', disabled: false }],
      // ctrluinv: [{ value: '', disabled: false }],
      // ctrllave: [{ value: '', disabled: false }],
      // cvecalidadper: [{ value: '', disabled: false }],
    })
  }
